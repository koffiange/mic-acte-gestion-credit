...
@ViewScoped
public class MouvementCreditCreateBacking extends BaseBacking {
    ...
    public void init(){
        ...
        if (params.containsKey("categorieActeCode"))
            categorieActe = CategorieActe.valueOf(params.get("categorieActeCode"));
    }
